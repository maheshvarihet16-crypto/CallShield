...
function LoginForm() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (res?.error) {
        setError("Google OAuth is not configured yet. Please set GOOGLE_CLIENT_ID & GOOGLE_CLIENT_SECRET in .env.local, or use Email/Password sign in below.");
        setGoogleLoading(false);
      }
    } catch (err: unknown) {
      setError("Google OAuth requires GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET in .env.local. Please use Email/Password sign in for testing.");
      setGoogleLoading(false);
    }
  };
